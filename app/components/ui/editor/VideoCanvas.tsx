...
import { speedToTransitionMs, ZOOM_EASING, calculateZoomPhaseState, zoomLevelToFactor, calculateCursorFollowFocus } from "@/types/zoom.types";
...
export const VideoCanvas = forwardRef<VideoCanvasHandle, ExtendedVideoCanvasProps>(function VideoCanvas(props, ref) {
    ...
    const zoomTransform = useMemo(() => {
        ...
        const followCursorFrame = activeZoomFragment.followCursor && cursorData?.hasCursorData
        ...
        const isFollowingCursor = activeZoomFragment.followCursor && !!followCursorFrame && followedFocus.followAmount > 0;
        const transitionMs = isMoving || isFollowingCursor ? 50 : speedToTransitionMs(activeZoomFragment.speed);
        ...
        return {
            ...
            isMoving: isMoving || isFollowingCursor,
        };
