                ...
                <Dialog.Content className="fixed inset-x-0 bottom-0 top-16 bg-[#141417] z-[101] animate-in slide-in-from-bottom duration-300 overflow-y-auto lg:hidden">
                    ...
                    <div className="sticky top-0 z-10 bg-[#141417] border-b border-white/10 px-4 py-3 flex items-center justify-between">
                        <Dialog.Title className="text-lg font-semibold text-white flex items-center gap-2">
                            <Icon
                                icon={
                                    controlPanelProps.activeTool === "screenshot"
                                        ? "solar:gallery-wide-linear"
                                        : controlPanelProps.activeTool === "elements"
                                        ? "mdi:shape-outline"
                                        : controlPanelProps.activeTool === "audio"
                                        ? "mdi:volume-high"
                                        : controlPanelProps.activeTool === "zoom"
                                        ? "iconamoon:zoom-in-bold"
                                        : controlPanelProps.activeTool === "cursor"
                                        ? "ph:cursor-fill"
                                        : controlPanelProps.activeTool === "videos"
                                        ? "mdi:video-outline"
                                        : controlPanelProps.activeTool === "camera"
                                        ? "mdi:camera-outline"
                            ...
                            {controlPanelProps.activeTool === "videos" && "Videos"}
                            {controlPanelProps.activeTool === "camera" && "Cámara"}
                        </Dialog.Title>
