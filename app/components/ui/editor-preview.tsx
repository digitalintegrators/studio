  ...
  return (
    <div className="relative max-w-6xl mx-auto">
      ...
      <div className="bg-[#0A0A0A] border border-white/10 rounded-xl overflow-hidden shadow-2xl shadow-black/50 flex flex-col md:flex-row h-[600px] text-left">
        ...
        <div className="w-full md:w-64 bg-[#0F0F0F] border-r border-white/5 flex flex-col shrink-0">
          ...
          <div className="p-5 space-y-6 overflow-y-auto editor-scroll">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <div className="aspect-square rounded border border-white/5 bg-gradient-to-br from-neutral-800 to-neutral-900 cursor-pointer hover:border-white/20"></div>
                <div className="aspect-square rounded border border-white/5 bg-[#1a1a1a] cursor-pointer hover:border-white/20"></div>
                <div className="aspect-square rounded border border-white/5 relative overflow-hidden cursor-pointer hover:border-white/20 group">
        ...
        <div className="flex-1 bg-[#141414] relative flex flex-col">
          <div className="h-12 border-b border-white/5 flex items-center justify-center gap-1 px-4">
          ...
          <div className="flex-1 flex items-center justify-center p-8 overflow-hidden relative">
            ...
            <div className="relative w-[80%] aspect-video bg-[#1a1a1a] rounded-lg shadow-2xl border border-white/10 overflow-hidden transform transition-transform duration-700 hover:scale-[1.02]">
              <div className="h-8 bg-[#252525] flex items-center px-3 border-b border-white/5">
          ...
          <div className="h-32 bg-[#0F0F0F] border-t border-white/5 flex flex-col">
            <div className="h-6 border-b border-white/5 flex items-end px-2">
            ...
            <div className="flex-1 p-3 relative overflow-hidden">
              <div className="space-y-2">
                <div className="h-8 bg-neutral-800/50 rounded flex items-center overflow-hidden border border-white/5 relative">
                ...
                <div className="h-6 bg-neutral-800/30 rounded flex items-center px-2 overflow-hidden border border-white/5">
